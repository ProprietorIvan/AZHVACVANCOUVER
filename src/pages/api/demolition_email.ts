...
export default async function handler(
    ...
    if (request.method !== "POST") {
        return respond.status(405).json({ error: "Method not allowed" });
    }
    ...
    try {
        ...
        // Check environment variables - if not configured, just log the submission
        if (!process.env.SMTP_USER || !process.env.SMTP_PASSWORD) {
            console.log("SMTP not configured, logging form submission:");
            console.log("=== DEMOLITION QUOTE REQUEST ===");
            console.log(`Name: ${name}`);
            console.log(`Email: ${email}`);
            console.log(`Phone: ${phone}`);
            console.log(`Address: ${address}`);
            console.log(`Customer Type: ${customerType || "Not specified"}`);
            console.log(`Facility Type: ${facilityType || "Not specified"}`);
            console.log(`Project Size: ${projectSize || "Not specified"}`);
            console.log(`Urgency: ${urgency || "Not specified"}`);
            console.log(`Project Details: ${projectDetails || "No additional details provided"}`);
            console.log("================================");

            return respond.status(200).json({ message: "Quote request received successfully" });
        }
        ...
        const mailOptions = {
            ...
            to,
            subject: "New Demolition Quote Request - Rockwell Prime",
            html: generateEmail({
                name,
                email,
                phone,
                ...
                facilityType: facilityType || "Not specified",
                projectSize: projectSize || "Not specified",
                urgency: urgency || "Not specified",
                customerType: customerType || "Not specified",
            }),
        };
        ...
        <html>
            ...
            <body>
                <div class="email-wrapper">
                    ...
                    <div class="footer">
                        <div style="font-weight: 500;">© 2026 Rockwell Prime Demolition & Abatement. All rights reserved.</div>
