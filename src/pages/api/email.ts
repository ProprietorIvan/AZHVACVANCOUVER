...
export default async function handler(
    ...
    if (request.method === "POST") {
        try {
            ...
            const { name = "", email = "", phone = "", address = "", images = [], quote = "", query = "" } = request.body;
...
function generateEmail({ name, email, phone, address, imgs, quote, query }: { 
    name: string, 
    email: string, 
    phone: string, 
    address: string, 
                ...
                <div class="email-wrapper">
                    ...
                    <div class="content">
                        <div class="section">
                            ...
                            ${query ? `<div class="info-label">Query</div><div class="info-value">${query}</div>` : ""}
                        </div>
