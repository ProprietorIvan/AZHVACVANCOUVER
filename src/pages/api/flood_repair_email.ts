    ...
    if (request.method === "POST") {
        try {
            ...
            const mailOptions = {
                ...
                to,
                subject: "New Emergency Flood Repair Request",
                html: generateEmail({
                    name,
                    email,
                    phone,
        ...
        <html>
            ...
            <body>
                <div class="email-wrapper">
                    <div class="header">
                        <h2>Emergency Flood Repair Request</h2>
                    </div>
                    ...
                    <div class="content">
                        <div class="section">
                            ...
                            ${projectDetails ? `<div class="info-label">Damage Details</div><div class="info-value">${projectDetails}</div>` : ""}
                            ${facilityType ? `<div class="info-label">Facility Type</div><div class="info-value">${facilityType}</div>` : ""}
                            ${projectSize ? `<div class="info-label">Project Size</div><div class="info-value">${projectSize}</div>` : ""}
                            ${urgency ? `<div class="info-label">Urgency Level</div><div class="info-value">${urgency}</div>` : ""}
                        </div>                        
                    </div>
